...
Covid Information Bank
  ...
  <div className="form_heading">
    Access to Database
      ...
      <div className="want">
        <Button style={{width:'200px',height:'150px',fontSize:'20px',background:'lightsalmon'}} variant="outlined" onClick={handleClickOpen}>
        I want To Help
      </Button>
      ...
      <div className="need">
        <Button style={{width:'200px',height:'150px',fontSize:'20px',background:'pink'}} variant="outlined" >
