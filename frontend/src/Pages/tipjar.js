  ...
  return (
    <div>
      ...
      <p className={`${ style.heading } `}>
        Want to share any experience or advice that might help others. Go ahead and fill the canvas below with your thoughts or scroll down to find out what others have to say.
      </p>
        ...
        {data.map((item) =>
        {
          return (
            ...
            <motion.div
              ...
              <p className={`${ style.descriptioncontent }`}>Tip: {item.description} </p>
            </motion.div>
          )
        })}
      </div>
